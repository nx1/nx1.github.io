...
csv_file = 'breakbeat_albums.csv' if os.path.exists('breakbeat_albums.csv') else 'breakbeat_album.csv'
...
for i, r in df.iterrows():
    ...
    # Get catno 
    c_max = 10
    c_str = str(r['catno']) if pd.notna(r['catno']) else ''
...
with open('breakbeat_albums.html', 'w+') as f:
    f.write("""
<html>
<head>
    <title>nx1.info | Breakbeat CDs 1993-2015</title>
...
<body>
<pre>
<h1>nx1.info | Breakbeat albums 1993-2015</h1>
