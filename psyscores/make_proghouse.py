...
with open('proghouse.html', 'w+') as f:
    f.write("""
<html>
<head>
    <title>nx1.info | Progressive House, Vinyl 2000-2009</title>
...
<body>
<pre>
<h1>nx1.info | Progressive House, Vinyl 2000-2009</h1>
